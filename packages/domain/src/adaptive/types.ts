...
export interface ReplanContext{profileId:string;planId:string;weekStart:string;weekEnd:string;currentDate:string;planningBudgetMinutes:number;dailyCapacities:Readonly<Record<string,number>>;tasks:readonly AdaptiveTask[];revisions:readonly AdaptiveRevision[];trigger:"capacity_change"|"backlog_risk"|"new_mastery"|"revision_due"|"manual_request"}
