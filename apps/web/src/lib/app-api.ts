...
export const FRIENDLY_API_ERRORS: Readonly<Record<string, string>> = {
  ...
  PHYSICAL_PAGE_BOUNDARY_REQUIRED: "Tamamladığınız son sayfayı girin.",
  PHYSICAL_PAGE_BOUNDARY_INVALID: "Sayfa numarası çalışma aralığının dışında.",
  PHYSICAL_PROGRESS_REVERSAL: "Kaydedilmiş ilerlemeden daha düşük bir sayfa seçemezsiniz.",
  PHYSICAL_PROGRESS_CHANGED_DURING_SESSION: "Sayfa ilerlemesi başka bir işlemde değişti. Verileri yenileyip tekrar deneyin.",
  PHYSICAL_BREAK_STATE_MISMATCH: "Mola kaydı güvenli biçimde doğrulanamadı. Verileri yenileyin.",
  PHYSICAL_SESSION_OWNERSHIP_CONFLICT: "Çalışma kaydının türü doğrulanamadı. Verileri yenileyin.",
  PHYSICAL_SESSION_CANCEL_UNAVAILABLE: "Bu fiziksel çalışmayı iptal etmek yerine bitirip son tamamlanan sayfayı girin.",
  PHYSICAL_RESOURCE_UNIT_SELECTION_INVALID: "Seçilen ünite bu görevin bekleyen fiziksel üniteleri arasında değil.",
